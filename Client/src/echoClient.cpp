...
int main (int argc, char *argv[]) {
    ...
    KeyboardListener task1(1, mutex);

    ServerListener task2(2, mutex);

 

    std::thread keyboardListenerThread(&Task::run, &task1);

    std::thread serverListenerThread(&Task::run, &task2);
